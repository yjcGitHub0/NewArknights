...
public class operDataEnum : Editor
{
    ...
    private SerializedProperty imageInDrag;
    private SerializedProperty imageInDragBack;
    ...
    void OnEnable()
    {
        ...
        imageInDrag = od_.FindProperty("imageInDrag");
        imageInDragBack = od_.FindProperty("imageInDragBack");
    ...
    public override void OnInspectorGUI()
    {
        ...
        else if(type.enumValueIndex == 1)
        {
            ...
            EditorGUILayout.PropertyField(imageInDrag);
            EditorGUILayout.PropertyField(imageInDragBack);
